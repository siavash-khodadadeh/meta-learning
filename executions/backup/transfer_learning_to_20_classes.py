...
LOG_DIR = 'logs/ucf101_transfer_learning_to_20_classes/'
TRAIN = True
NUM_CLASSES = 20
CLASS_SAMPLE_SIZE = 1
META_BATCH_SIZE = 1
...
def transfer_learn():
    ...
    maml.load_model(path='saved_models/transfer_learning/model-400', load_last_layer=False)
    ...
    for it in range(TRANSFER_LEARNING_ITERATIONS):
        ...
        if it % 50 == 0:
            if it % 100 == 0:
                maml.save_model('saved_models/transfer_learning_to_20_classes/model', step=it)
